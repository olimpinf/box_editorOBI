...
def main():
    ...
    for u in users:
        ...
        try:
            cmd = f"INSERT INTO users (first_name, last_name, username, password, preferred_languages) VALUES ('{u[2]}','{u[3]}','{u[0]}','plaintext:{u[1]}','{preferred_languages}') RETURNING id"
            cursor.execute(cmd)
            user_id = cursor.fetchone()[0]

            cmd = f"INSERT INTO participations (user_id, contest_id, delay_time, extra_time, hidden, unrestricted) VALUES ('{user_id}',{contest}, '00:00:00','00:00:00', False, False)"
